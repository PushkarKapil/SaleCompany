...
namespace SaleCompany.Controllers
{
    public class seedDatasController : Controller
    {
        private readonly SaleCompanyContext _context;

        public seedDatasController(SaleCompanyContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Quantity,Review,Price,image")] seedData seedData)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Quantity,Review,Price,image")] seedData seedData)
        {
            if (id != seedData.Id)
            {
                return NotFound();
